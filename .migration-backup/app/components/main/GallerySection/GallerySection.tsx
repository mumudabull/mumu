...
export default function GallerySection() {
  ...
  const columnData = useMemo(() => {
    ...
    return columns.map((col) => {
      // Repeating 4 times is plenty for a seamless loop and significantly reduces DOM nodes
    ...
    >
      ...
      >
        {columnData.map((images, colIndex) => {
          const isReverse = colIndex % 2 !== 0; // Alternate columns bottom to top
          ...
          return (
            <div
              ...
              style={{
                marginTop: `${colIndex * 20}px`, // Slight stagger for additional slant feel
              }}
            >
              <motion.div
